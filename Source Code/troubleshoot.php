...
<div id="page">
	<div id="content">
		<div class="post">
			<h1 class="title">Select you problem type by clicking to the picture... </h1>              
		</div>                
   <!--         <form method="GET" action="trava.php" id="form">
					<input type="radio" name="part" value="monitorgpu" />Monitor<br />
    				<input type="radio" name="part" value="keyboard" />Keyboard<br />
    				<input type="radio" name="part" value="mouse" />Mouse<br />
    				<input type="radio" name="part" value="HDD" />Hard Disc<br />
                	<input type="radio" name="part" value="CDDVD" />Cd/Dvd Drives<br />
    				<input type="radio" name="part" value="PSU" />PSU<br />
					<input type="hidden" name="node" value="1"  /> 
					<input type="submit" value="Next" onsubmit="loadXMLDoc()"/>
    		</form><br />-->
